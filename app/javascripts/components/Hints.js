...
const Hints = {
  'attr_map' : (<em>
    Rules for scraping the platform&apos;s html and parsing it into episodes. Each property of the episode has a selector mapped to it, this is how the data is extracted.
  </em>),
  'pagination' : (<em>
